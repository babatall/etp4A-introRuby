...
#Le premier puts passe mais le seond genere error 
#La variable number_of_minutes_in_an_hourn n'est pas declarer donc il ne peut etre utiliser dans ce programme